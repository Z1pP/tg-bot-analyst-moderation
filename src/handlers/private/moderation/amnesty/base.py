"""Общие хендлеры и диспетчер для сценария амнистии."""
...
from .cancel_warn import execute_cancel_warn
from .unban import execute_unban
from .unmute import execute_unmute
...
ACTION_EXECUTORS = {
    InlineButtons.Moderation.UNBAN: execute_unban,
    InlineButtons.Moderation.UNMUTE: execute_unmute,
    InlineButtons.Moderation.CANCEL_WARN: execute_cancel_warn,
}
...
async def amnesty_execute_handler(
    ...
    try:
        text = await executor(amnesty_dto, container)
