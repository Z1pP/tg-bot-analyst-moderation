...
from usecases.chat import GetChatWithArchiveUseCase, ToggleWelcomeTextUseCase
...
@router.callback_query(F.data == CallbackData.Chat.WELCOME_TEXT_TOGGLE)
async def toggle_welcome_text_handler(
    callback: CallbackQuery,
    state: FSMContext,
    container: Container,
) -> None:
    """Обработчик включения/выключения приветственного текста."""
    ...
    toggle_usecase: ToggleWelcomeTextUseCase = container.resolve(
