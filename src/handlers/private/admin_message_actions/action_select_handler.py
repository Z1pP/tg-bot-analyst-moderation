...
@router.callback_query(
    AdminMessageActionsStates.waiting_action_select,
...
async def message_action_select_handler(
    ...
    if callback.data == "delete_message":
        ...
        await log_and_set_state(
            callback.message, state, AdminMessageActionsStates.waiting_delete_confirm
        )
        ...
        await log_and_set_state(
            callback.message, state, AdminMessageActionsStates.waiting_reply_message
        )
